...
vcpkg_from_github(
    ...
    PATCHES
        ...
        android-cmake-os.patch
        android-bionic-posix.patch
)

set(CRYPTO_BACKEND OpenSSL)

set(GNS_CONFIGURE_OPTIONS
    -DBUILD_TESTS=OFF
    -DBUILD_EXAMPLES=OFF
    -DBUILD_TOOLS=OFF
...
# Android: pthread lives in libc; FindThreads must not add -lpthread (no libpthread.so).
if(VCPKG_TARGET_IS_ANDROID)
    list(APPEND GNS_CONFIGURE_OPTIONS "-DCMAKE_HAVE_LIBC_PTHREAD=ON")
endif()

vcpkg_cmake_configure(
    SOURCE_PATH "${SOURCE_PATH}"
    OPTIONS
        ${GNS_CONFIGURE_OPTIONS}
)
